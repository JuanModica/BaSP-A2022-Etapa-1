...
/* a. Crear un array que contenga 5 palabras 
y recorrer dicho array utilizando un bucle for de JavaScript para mostrar una alerta utilizando cada una de las palabras. */

console.log('\n-Exercise 5.a:');

var asereje = ['avecina', 'esquina', 'viene', 'diego', 'rumbeando'];
...
for (var i=0; i < asereje.length; i++) {
    alert(asereje[i].substring(0, 1).toUpperCase() + asereje[i].substring(1).toLowerCase());
}
